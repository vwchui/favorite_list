...
**Import:** `import { MenuDescriptionItem } from "./components/Menu"`
**Category:** components
**Intent:** Triggered action menu

## Composition

`MenuDescriptionItem` is part of a compound component. Use together with: `MenuItem`, `MenuInfoItem`, `MenuNote`, `MenuSectionTitle`, `MenuBreadcrumbItem`, `MenuSubMenu`, `MenuSectionTitleAccordion`, `MenuEditItem`, `Menu`.
