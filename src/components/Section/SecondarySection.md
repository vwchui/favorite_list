...
**Import:** `import { SecondarySection } from "./components/Section"`
**Category:** components

## Composition

`SecondarySection` is part of a compound component. Use together with: `PrimarySection`, `TertiarySection`.
