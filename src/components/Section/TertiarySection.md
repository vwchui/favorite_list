...
**Import:** `import { TertiarySection } from "./components/Section"`
**Category:** components

## Composition

`TertiarySection` is part of a compound component. Use together with: `PrimarySection`, `SecondarySection`.
