...
**Import:** `import { SelectDropdownCheckboxItem } from "./components/SelectDropdown"`
**Category:** components
...
- `disabled`: boolean
- `closeOnSelect`: boolean — Close the menu after toggling. Defaults to `false` so multi-select menus
- `children`: ReactNode
