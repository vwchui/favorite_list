...
**Import:** `import { SelectDropdownItem } from "./components/SelectDropdown"`
**Category:** components
...
- `inset`: boolean
- `disabled`: boolean
- `destructive`: boolean — Renders the item with destructive styling (e.g. a "Delete" action).
- `onSelect`: () => void
- `children`: ReactNode
